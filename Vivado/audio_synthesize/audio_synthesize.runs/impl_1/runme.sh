...
HD_PWD='L:/HAWCloud/SSPSynthesize/audio_synthesize/audio_synthesize.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AUDIO_SYSTEM_TOP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AUDIO_SYSTEM_TOP.tcl -notrace
