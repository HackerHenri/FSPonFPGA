...
HD_PWD='L:/HAWCloud/SSPSynthesize/audio_synthesize/audio_synthesize.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AUDIO_SYSTEM_TOP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AUDIO_SYSTEM_TOP.tcl
