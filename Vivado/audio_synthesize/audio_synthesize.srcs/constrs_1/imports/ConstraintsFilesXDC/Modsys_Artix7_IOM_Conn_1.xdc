...
##IN0: 
# set_property PACKAGE_PIN D3  [get_ports       {IOM_IN[0]}] 
# set_property IOSTANDARD LVCMOS33 [get_ports   {IOM_IN[0]}] 

##IN1:
# set_property PACKAGE_PIN H1  [get_ports       {IOM_IN[1]}] 
# set_property IOSTANDARD LVCMOS33 [get_ports   {IOM_IN[1]}]
